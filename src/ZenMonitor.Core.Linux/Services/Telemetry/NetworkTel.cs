...
/// <summary>
/// Linux implementation of <see cref="INetworkTel"/> that reads network interface metrics
/// from <c>/proc/net/dev</c> and <c>/sys/class/net/*/operstate</c>.
/// </summary>
[SupportedOSPlatform("linux")]
public class NetworkTel(ILogger<NetworkTel> logger, IFileSystem fileSystem, IUtilsLinux utils) : INetworkTel
{
