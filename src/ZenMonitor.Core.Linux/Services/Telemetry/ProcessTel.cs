...
/// <summary>
/// Linux implementation of <see cref="IProcessTel"/> that reads process information
/// from the <c>/proc</c> filesystem.
/// </summary>
[SupportedOSPlatform("linux")]
public class ProcessTel(ILogger<ProcessTel> logger, IFileSystem fileSystem, IUtilsLinux utils) : IProcessTel
{
