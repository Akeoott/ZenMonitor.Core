...
/// <summary>
/// Windows implementation of <see cref="IDriveTel"/> that reads DriveTel metrics
/// via native Win32 API calls through <see cref="IUtilsWindows"/>.
/// </summary>
[SupportedOSPlatform("windows")]
public class DriveTel(ILogger<DriveTel> logger) : IDriveTel
{
    ...
    private DriveInfoSnapshot FetchDriveInfo()
    {
        ...
        {
            logger.LogError(ex, "Failed to fetch Drive info");
