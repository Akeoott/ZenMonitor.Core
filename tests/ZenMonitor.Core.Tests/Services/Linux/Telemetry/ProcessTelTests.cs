...
public class ProcessTelTests
{
    private readonly Mock<ILogger<ProcessTel>> _mockLogger = new();
    private readonly MockFileSystem _mockFileSystem = new();
    private readonly Mock<IUtilsLinux> _mockUtils = new();

    private const int MockProcessorCount = 4;

    private ProcessTel CreateProcess() => new(_mockLogger.Object, _mockFileSystem, _mockUtils.Object);
