...
public class CpuTelTests
{
    private readonly Mock<ILogger<CpuTel>> _mockLogger = new();
    private readonly MockFileSystem _mockFileSystem = new();
    private readonly Mock<IUtilsLinux> _mockUtils = new();

    private CpuTel CreateCpu() => new(_mockLogger.Object, _mockFileSystem, _mockUtils.Object);
