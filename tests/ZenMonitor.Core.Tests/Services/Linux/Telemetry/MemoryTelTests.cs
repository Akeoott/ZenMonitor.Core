...
public class MemoryTelTests
{
    private readonly Mock<ILogger<MemoryTel>> _mockLogger = new();
    private readonly MockFileSystem _mockFileSystem = new();

    private MemoryTel CreateMemory() => new(_mockLogger.Object, _mockFileSystem);
