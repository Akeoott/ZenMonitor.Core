...
public class NetworkTelTests
{
    private readonly Mock<ILogger<NetworkTel>> _mockLogger = new();
    private readonly MockFileSystem _mockFileSystem = new();
    private readonly Mock<IUtilsLinux> _mockUtils = new();

    private NetworkTel CreateNetwork() => new(_mockLogger.Object, _mockFileSystem, _mockUtils.Object);
