...
public class SystemTelTests
{
    private readonly Mock<ILogger<SystemTel>> _mockLogger = new();
    private readonly MockFileSystem _mockFileSystem = new();

    private SystemTel CreateSystem() => new(_mockLogger.Object, _mockFileSystem);
